  ...
  <div class="app-container">
    <v-app>
      <v-app-bar color="primary" app>
        <v-app-bar-title>PVE虚拟机守护神</v-app-bar-title>
        <v-spacer></v-spacer>
        <v-btn text @click="activeTab = 'page'" :disabled="activeTab === 'page'">状态页</v-btn>
        <v-btn text @click="activeTab = 'config'" :disabled="activeTab === 'config'">配置</v-btn>
      </v-app-bar>
      ...
      <v-footer app color="primary" class="text-center d-flex justify-center">
        <span class="text-white">MoviePilot PVE虚拟机守护神本地测试 ©{{ new Date().getFullYear() }}</span>
      </v-footer>
    </v-app>
